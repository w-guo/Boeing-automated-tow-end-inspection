...
# 1. Add EarlyStopping as another callback
# 2. Change quantity to monitor to "val_loss"
...
class SnapshotCallbackBuilder:
    ...
    def get_callbacks(self, model_prefix='Model'):
        ...
        Returns: list of 4 callbacks [ModelCheckpoint, LearningRateScheduler, EarlyStopping
        ...
        callback_list = [
            ModelCheckpoint("weights/%s_best.h5" % model_prefix,
                            save_best_only=True),
